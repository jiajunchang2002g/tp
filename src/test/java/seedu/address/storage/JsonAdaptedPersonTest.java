...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_STAGE, VALID_ALIASES, VALID_NOTES, VALID_RISK, VALID_TAGS, EMPTY_ENCOUNTERS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_STAGE, VALID_ALIASES, VALID_NOTES, VALID_RISK, VALID_TAGS, EMPTY_ENCOUNTERS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_STAGE, VALID_ALIASES, VALID_NOTES, VALID_RISK, VALID_TAGS, EMPTY_ENCOUNTERS);
    ...
    public void toModelType_invalidNotes_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_STAGE, VALID_ALIASES, INVALID_NOTES, VALID_RISK, VALID_TAGS, EMPTY_ENCOUNTERS);
    ...
    public void toModelType_invalidRisk_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_STAGE, VALID_ALIASES, VALID_NOTES, INVALID_RISK, VALID_TAGS, EMPTY_ENCOUNTERS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_STAGE, VALID_ALIASES, VALID_NOTES, VALID_RISK, invalidTags, EMPTY_ENCOUNTERS);
